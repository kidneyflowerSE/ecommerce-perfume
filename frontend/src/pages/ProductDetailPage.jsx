        ...
        <div>
            ...
            <div className="w-full flex mt-10">
                <div className="w-1/2 flex justify-center">
                    <img src="/assets/2.jpg" alt="" className="w-[500px] h-[500px]"/>
                </div>
                <div className="w-1/4 flex flex-col">
                    ...
                    <span className="py-4 border-b tracking-wider flex justify-between">
                        <span>Brand: <span>{product.brand.name}</span></span>
                        <span>Xuất sứ: <span>{product.brand.country}</span></span>
                    ...
                    <button className="mt-8 py-4 border-2 border-black">
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="w-2/3 flex flex-col justify-center tracking-wide border-b">
                    ...
                    <div className="py-2">
                        ...
                        <p className="text-sm font-light">{product.brand.description}</p>
                    </div>
                    <div className="py-2">
