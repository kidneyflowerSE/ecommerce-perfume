...
const UnisexProduct = () => {
  ...
  useEffect(() => {
    const storedProducts = localStorage.getItem("menProducts");
    ...
    if (storedProducts) {
      ...
      axios
        ...
        .then((response) => {
          setMenProducts(response.data);  // Fix here
          localStorage.setItem("menProducts", JSON.stringify(response.data)); 
          setLoading(false);
        })
        .catch((error) => {
        ...
        >
          ...
          <div className="flex flex-col w-full justify-center items-center p-4">
            ...
            <span className="text-xs font-light justify-between w-full flex my-1">
              ...
              <span className="bg-black p-2 rounded font-normal text-white">2178 đã bán</span>
            </span>
